...
@section('title', 'Create User - Oweru Admin')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="user_type" class="form-select @error('user_type') is-invalid @enderror" required>
                            ...
                            <option value="store_owner" {{ old('user_type') == 'store_owner' ? 'selected' : '' }}>Store Owner</option>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check">
                            <input type="checkbox" name="is_verified" class="form-check-input" value="1" {{ old('is_verified') ? 'checked' : '' }}>
